...
<!DOCTYPE html>
  ...
  <body onload="displayPendingPosts()">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active"><a class="nav-link" style="cursor:pointer" onclick="displayPendingPosts()">Pending Posts<span class="sr-only">(current)</span></a></li>
    ...
    <div class="main" style="min-height:700px;">
        <div class="container-fluid">
            <div class="row content">
                <div class="col-lg-2 col-md-3 sidenav">
                    <h4>4 Tech Blog</h4>
                    <hr>
                    <ul class="nav nav-pills nav-stacked">
                        <li class="btn btn-info" style="font-size:15px" id="PostABlog">Add Blog</li>
                        <li class="btn btn-info" style="font-size:15px">Notifications</li>
                        <li class="btn btn-info" style="font-size:15px">Users</li>
                    </ul>
                    <hr>
                    <form class="input-group form-inline my-2 my-lg-0">
                        <input type="text" class="form-control" placeholder="Search ..">
				...
				<!-- below division will use to retrieve data and displaying on above id=load-->
